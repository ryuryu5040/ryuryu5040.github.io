  ...
  return (
    <div>
      <div className='flex justify-between items-baseline mb-10'>
        <h1 className={`${zenMaru.className} text-6xl font-bold`}>Lighthouse</h1>
        <Link
            href="/tarkov-maps"
      ...
      <MapViewer 
      images={[
        { label: '説明無し', src: '/images/tarkovMaps/lighthouseMap.webp' },
      ]}/>

      <div className={`${zenMaru.className}`}>
        <div className = "mb-2">
            <Link
                href="https://escapefromtarkov.fandom.com/wiki/Lighthouse"
            ...
            <Link 
                href="https://wikiwiki.jp/eft/LIGHTHOUSE"
                className="text-orange-400 hover:text-orange-800 underline decoration-2 underline-offset-4 transition-colors items-center mx-2"
                target="_blank">
                    日本語Wiki
            </Link>
