  ...
  return (
    <div>
      <div className='flex justify-between items-baseline mb-10'>
        <h1 className={`${zenMaru.className} text-6xl font-bold`}>Shoreline</h1>
        <Link
            href="/tarkov-maps"
      ...
      <MapViewer 
      images={[
        { label: '説明無し', src: '/images/tarkovMaps/shorelineMap.webp' },
        { label: '説明付き', src: '/images/tarkovMaps/shorelineMapText.png' },
      ]}/>

      <div className={`${zenMaru.className}`}>
        <div className = "mb-2">
            <Link
                href="https://escapefromtarkov.fandom.com/wiki/Shoreline"
            ...
            <Link 
                href="https://wikiwiki.jp/eft/SHORELINE"
                className="text-orange-400 hover:text-orange-800 underline decoration-2 underline-offset-4 transition-colors items-center mx-2"
                target="_blank">
                    日本語Wiki
            </Link>
