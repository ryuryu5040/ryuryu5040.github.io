...
function page() {
  ...
  return (
    <div>
      ...
      <MapViewer 
      images={[
        { label: '説明無し', src: '/images/tarkovMaps/interchangeMap.webp' },
        { label: '説明付き', src: '/images/tarkovMaps/interchangeMapText.jpg' },
      ]}/>

      <div className={`${zenMaru.className}`}>
        <div className = "mb-2">
            <Link
                href="https://escapefromtarkov.fandom.com/wiki/Interchange"
            ...
            <Link 
                href="https://wikiwiki.jp/eft/INTERCHANGE"
                className="text-orange-400 hover:text-orange-800 underline decoration-2 underline-offset-4 transition-colors items-center mx-2"
                target="_blank">
                    日本語Wiki
            </Link>
